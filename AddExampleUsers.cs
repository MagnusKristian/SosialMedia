...
public class AddExampleUsers
{
    ...
    public List<Profile> AddUsers()
    {
        ...
        Users.Add(new Profile("FriendlessPerson FriendlessLastname")); // "FriendlessPerson FriendlessLastname"
        ...
        Users.Add(new Profile("KristianG Granaas")); // "Kristian1 Granaas"
        Users.Add(new Profile("KristianB Braathen")); // "Kristian2 Braathen"
